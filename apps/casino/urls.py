...
from .views import (Casino25APIView, Casino25CallBackAPIView, Casino25GameList,
    ...
    GetPlayersFavCasinoGames, ModifyCasinoGamesAPIView, ScoreboardApiView, SearchView, TournamentDetailApiView,
...
urlpatterns = [
    ...
    url(r"modify-casino-games", ModifyCasinoGamesAPIView.as_view(), name="modify-casino-games"),
